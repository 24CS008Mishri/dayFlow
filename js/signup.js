...
window.addEventListener('DOMContentLoaded', function() {
    ...
    // Redirect to login if not Admin or HR
    if (!userRole || (userRole !== 'admin' && userRole !== 'hr')) {
        alert('You do not have permission to access this page. Only Admin or HR can add new employees.');
        window.location.href = 'index.html';
    }
    
    // Update header to reflect user role
